...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "update_user_requestBody")]
    public partial class UpdateUserRequestBody : IEquatable<UpdateUserRequestBody>, IValidatableObject
    {
        ...
        /// <param name="country">[ISO 3166-1 alpha-3](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3#Officially_assigned_code_elements) country code (3 char).</param>
        ...
        public UpdateUserRequestBody(string firstName = "Neol1556506027", string lastName = default(string), string email = default(string), string mobile = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string state = default(string), string city = default(string), string zip = default(string), string country = default(string), string dob = default(string), string governmentNumber = default(string), string driversLicenseNumber = default(string), string driversLicenseState = default(string), string ipAddress = default(string), string logoUrl = default(string), string color1 = default(string), string color2 = default(string), string customDescriptor = default(string))
        {
            // to ensure "firstName" is required (not null)
            if (firstName == null) {
                throw new ArgumentNullException("firstName is a required property for UpdateUserRequestBody and cannot be null");
            }
